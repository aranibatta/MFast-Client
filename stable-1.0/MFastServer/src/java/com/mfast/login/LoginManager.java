...
public class LoginManager {
    ...
    private static int createLoginSession(Connection conn, int therapistId, int locationId) throws Exception{
        int sessionId = 0;                                                          
        String sql = "INSERT INTO LoginSession(LoggedInTherapist, LoginSessionActive, LoginSessionStartActivityTS, LoginSessionLastActivityTS, LoggedInLocation) VALUES(?,?,?,?,?)";
        ...
        st.setTimestamp(4, Util.getTS());
        st.setInt(5, locationId);
